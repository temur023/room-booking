        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComapanyId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Rooms_Comapanies_ComapanyId",
                        column: x => x.ComapanyId,
                        principalTable: "Comapanies",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Comapanies_ComapanyId",
                        column: x => x.ComapanyId,
                        principalTable: "Comapanies",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_ComapanyId",
                table: "Rooms",
                column: "ComapanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Users_ComapanyId",
                table: "Users",
                column: "ComapanyId");
        }
